...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      <Head>
        <title>Register | HealthOrbit.Ai</title>
        <meta name="description" content="Create your HealthOrbit.Ai account" />
      </Head>
      ...
      <main className="container mx-auto px-4 flex flex-col items-center justify-center min-h-screen relative z-10">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Join HealthOrbit.Ai today</p>
          </div>
